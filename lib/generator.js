...
var _extrudeCommand = function (inputFile, outputFile, extrude) {
  ...
  var command = 'convert -size ' + resize + ' -define png:exclude-chunks=date "' + inputFile + '" -set option:distort:viewport ' + viewport + ' -virtual-pixel Edge -distort SRT 0 -filter point +repage ' + outputFile;
	return command;
};
